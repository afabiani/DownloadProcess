...
gxp.plugins.WPSManager =  Ext.extend(gxp.plugins.Tool,{
    ...
    execute: function(processName, executeRequest) {
        ...
        executeOptions.success= this.responseManager.createDelegate(this, [function(instanceIndex, instancesStatusUpdated, entityID, resourceInstance) {
            ...
            if(res != null){
                ...
                geoStore.updateEntity(resourceInstance, function(entityID){
                    if(! entityID){
                        ...
                        if(callback)
                            callback.call(this,instanceIndex, instancesStatusUpdated, entityID, resourceInstance);
                    }
                }/*, function(){
